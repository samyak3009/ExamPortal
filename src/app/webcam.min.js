(function(e) {
    ...
    var Webcam = {
        ...
        savePreview: function(e, t) {
            ...
            e(t ? null : s.toDataURL("image/" + a.image_format, a.jpg_quality / 100), s, i);
            this.unfreeze()
        },
        snap: function(e, t) {
            var a = this;
            ...
            var h = function() {
                ...
                e(t ? null : r.toDataURL("image/" + i.image_format, i.jpg_quality / 100), r, o)
            };
            if (this.userMedia) {
        ...
        upload: function(e, t, a) {
            ...
            var n = new Blob([this.base64DecToArr(r)], {
                type: "image/" + i
            });
            var l = new FormData;
