(function() {
  'use strict';
  angular.module('minotaur').directive('ngWebcam', ngWebcam);
  ngWebcam.$inject = [];
  /**
   *  @ngdoc Directive
   *  @name ng-webcam
  ...
  function ngWebcam() {
    ...
    function ngWebcamController($scope, $interval) {
      ...
      function onWebcamCapture() {
        //alert("onWebcamCapture")
        if(angular.isUndefined(vm.config.countdown)) {


        //alert("onWebcamCapture if")
          var count = 0;
        ...
        //
        // //alert(countdownTimer !== undefined)
